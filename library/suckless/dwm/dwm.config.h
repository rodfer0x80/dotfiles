...
static const char *torbrowser[]  = { "setsid", "-f", "firejail", "torbrowser-launcher", NULL };
static const char *qbittorrent[]  = { "setsid", "-f", "qbittorrent", NULL };
static const char *vlc[]  = { "setsid", "-f", "vlc", NULL };
static const char *mpdmuse[]  = { "/home/rodfer/.xscripts/mpdmuse.sh", NULL };
static const char *ardour[]  = { "setsid", "-f", "ardour7", NULL };
static const char *keepassxc[]  = { "setsid", "-f", "keepassxc", NULL };
...
static const char *syssleep[]  = { "systemctl", "sleep", NULL };
...
static Key keys[] = {
    ...
    { MODKEY|ShiftMask,             XK_m,           spawn,          {.v = mpdmuse} },
