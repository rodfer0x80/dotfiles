...
# Ensure figlet is installed, otherwise provide instructions
if ! command -v figlet &> /dev/null
then
    echo "figlet could not be found. Please install it using 'sudo apt-get install figlet'."
    exit
fi
...
# Define a large font for figlet
font="big"
