...
#define XK_Bluetooth       0x1008ff94 // F10
#define XK_Microphone      0x1008ffb2 // F4
#define XK_Gear            0x1008ff81 // F8
#define XK_Insert          0x0000ff63 // Insert
#define XK_Star            0x1008ff30 // Fn12 Star
// F1-12 conversions
...
//static const char dmenufont[]       = "Hack Nerd Font Mono:pixelsize=32:antialias=true;autohind=true";
static const char col_gray1[]       = "#ff8500";
static const char col_gray2[]       = "#333333";
static const char col_gray3[]       = "#cccccc";
static const char col_gray4[]       = "#ff8500";
static const char col_cyan[]        = "#ff8500";
...
static const char *firefox[]  = { "setsid", "-f", "firejail", "--private=/home/rodfer/.local/share/firefox", "firefox", NULL };
static const char *chromium[]  = { "setsid", "-f", "chromium", NULL };
static const char *obs[]  = { "setsid", "-f", "obs", NULL };
static const char *rofi[]  = { "setsid", "-f", "rofi", "-show", "drun", "-show-icons", NULL };
static const char *thunderbird[]  = { "setsid", "-f", "thunderbird", NULL };
static const char *gimp[]  = { "setsid", "-f", "gimp", NULL };
static const char *torbrowser[]  = { "setsid", "-f", "firejail", "tor-browser", NULL };
static const char *tornetwork[]  = { "/bin/sh", "/home/rodfer/.xscripts/tor_toggle.sh", NULL };
static const char *qbittorrent[]  = { "setsid", "-f", "qbittorrent", NULL };
static const char *ymuse[]  = { "setsid", "-f", "ymuse", NULL };
static const char *kvm[]  = { "setsid", "-f", "virt-manager", NULL };
static const char *hexchat[] = { "setsid", "-f", "hexchat", NULL };
...
static const char *incsound[]  = { "/bin/sh", "/home/rodfer/.xscripts/sound_inc.sh", NULL };
static const char *decsound[]  = { "/bin/sh", "/home/rodfer/.xscripts/sound_dec.sh", NULL };
static const char *mictoggle[]  = { "/bin/sh", "/home/rodfer/.xscripts/mic_toggle.sh", NULL };
static const char *shutdown[]  = { "shutdown", "now", NULL };
static const char *syshibernate[]  = { "systemctl", "hibernate", NULL };
static const char *syssleep[]  = { "systemctl", "suspend", NULL };
static const char *slock[]  = { "setsid", "-f", "slock", NULL };
...
static const char *archupdate[] = { "/bin/sh", "/home/rodfer/.xscripts/arch_update.sh 2>/var/log/arch_update", NULL };

static Key keys[] = {
	/* modifier                     key             function        argument */
	//{ MODKEY,                       XK_s,           spawn,          {.v = dmenucmd } },
  { MODKEY|ShiftMask,             XK_s,           spawn,          {.v = rofi } },
  ...
  { 0,                            XK_Star,        spawn,          {.v = tornetwork } },
  { MODKEY|ShiftMask,             XK_r,           spawn,          {.v = obs } },
  { MODKEY|ShiftMask,             XK_m,           spawn,          {.v = ymuse} },
  { MODKEY|ShiftMask,             XK_x,           spawn,          {.v = kvm } },
  { MODKEY|ShiftMask,             XK_h,           spawn,          {.v = hexchat } },
  { 0,                            XK_Home,        spawn,          {.v = nextbg } },
  { MODKEY,                       XK_Insert,      spawn,          {.v = archupdate } },
  { MODKEY|ShiftMask,             XK_Delete,      spawn,          {.v = shutdown } },
  { MODKEY,                       XK_Home,        spawn,          {.v = slock } },
  { MODKEY|ShiftMask,             XK_End,         spawn,          {.v = syshibernate } },
  { MODKEY,                       XK_Delete,      spawn,          {.v = syssleep } },
  { MODKEY,                       XK_Esc,         spawn,          {.v = slock } },
  ...
  { 0,                            XK_ToggleSound, spawn,          {.v = togglesound } },
	...
	{ MODKEY|ShiftMask,             XK_F3,          mpdchange,      {.i = +1} },
	{ MODKEY|ShiftMask,             XK_F1,          mpdcontrol,     {0} },
};
